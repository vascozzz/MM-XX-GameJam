...
public class PlatformGenerator : MonoBehaviour {
    ...
    public void Initialize(Camera cam, GameObject[] platforms, GameObject platformsContainer, float leftCorner, float rightCorner, float startY)
    {
        this.cam = cam;
    ...
    public void Generate()
    {
        ...
        while (currentGenY + randomGap < topEdge)
        {
            ...
            GameObject platformObj = Instantiate(platform, new Vector3(platformPosX, currentGenY, 0), Quaternion.identity) as GameObject;
            platformObj.transform.parent = platformsContainer.transform;
